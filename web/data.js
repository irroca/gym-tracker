    ...
    dailyRoutines: {
        ...
        "5": { // 周五
            ...
            workouts: [
                ...
                { id: "w5_2", name: "哑铃推举 + 反向箭步蹲", sets: "3×8/侧", remark: "原地后撤步完成，无需行走空间" },
                { id: "w5_3", name: "引体向上 或 高位下拉", sets: "3×8–10", remark: "拉链补充" },
                { id: "w5_4", name: "壶铃摆荡（俄式）", sets: "3×15", remark: "髋铰链爆发" },
                { id: "w5_5", name: "负重静力站立（农夫保持）", sets: "3×45s", remark: "双手持哑铃原地静站、收紧核心，替代农夫行走" },
        ...
        "6": { // 周六
            ...
            meals: [
                ...
                { id: "m6_5", time: "12:00", title: "午餐", desc: "主食1拳量(约150g) + 蛋白1掌量(约120g) + 绿叶菜2份 (约600kcal)" },
                { id: "m6_6", time: "15:30", title: "加餐", desc: "无糖希腊酸奶150g + 原味坚果15g (约220kcal)" },
                { id: "m6_7", time: "18:00", title: "晚餐", desc: "主食1拳量(120g) + 蛋白1掌量(110g) + 绿叶菜2份 (约480kcal)" },
        ...
        "0": { // 周日
            ...
            meals: [
                { id: "m0_1", time: "10:15", title: "早餐", desc: "燕麦25g(半量) + 牛奶250ml + 全蛋2个+蛋白2个 + 鸡胸80g或牛肉60g (无香蕉); 肌酸5g、维D3/鱼油/复合维生素随餐 (约530kcal)" },
                { id: "m0_2", time: "12:00", title: "午餐", desc: "主食半拳量(约80g) + 蛋白1掌量(约130g) + 绿叶菜2份 (约490kcal)" },
                { id: "m0_3", time: "15:30", title: "加餐", desc: "无糖希腊酸奶150g + 原味坚果15g (约220kcal)" },
                { id: "m0_4", time: "18:00", title: "晚餐", desc: "主食半拳量(约80g) + 蛋白1掌量(约120g) + 绿叶菜2份 (约480kcal)" },
                { id: "m0_5", time: "21:30", title: "夜宵(可选)", desc: "无糖希腊酸奶100g，慢吸收蛋白助夜间恢复 (约100kcal)" },
